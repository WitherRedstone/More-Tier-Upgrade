...
public class ModRecipesProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_5.get())
                ...
                .unlockedBy("has_stack_upgrade_tier_ss_6", has(StickUpgradeItem.STACK_UPGRADE_TIER_SS_6.get()))
                .save(output, MoreTierUpgrade.MOD_ID + ":stack_upgrade_tier_sb_5_for_ss");

        // 堆叠升级T6 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_6.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        // 堆叠升级T7 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_7.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        // 堆叠升级T8 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_8.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        // 堆叠升级T9 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_9.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        // 堆叠升级T10 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_10.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        // 堆叠升级T11 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SB_11.get())
                .pattern("BBB")
                .pattern("BAB")
                .pattern("BBB")
        ...
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_6.get())
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_6.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
                .define('B', StickUpgradeItem.STACK_UPGRADE_TIER_SB_5.get())
                .unlockedBy("has_stack_upgrade_tier_sb_5", has(StickUpgradeItem.STACK_UPGRADE_TIER_SB_5.get()))
                .save(output, MoreTierUpgrade.MOD_ID + ":stack_upgrade_tier_ss_6_for_sb");

        // 堆叠升级T7 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_7.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_7.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
        ...
        // 堆叠升级T8 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_8.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_8.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
        ...
        // 堆叠升级T9 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_9.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_9.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
        ...
        // 堆叠升级T10 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_10.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_10.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
        ...
        // 堆叠升级T11 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_11.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_11.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
        ...
        // 堆叠升级T12 - 本体 - 转换
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_12.get())
                .pattern("CCC")
                .pattern("CAC")
                .pattern("BCB")
                ...
                .save(output);
        ShapedRecipeBuilder.shaped(itemRegistryLookup, RecipeCategory.MISC, StickUpgradeItem.STACK_UPGRADE_TIER_SS_12.get(), 3)
                .pattern("ABA")
                .pattern(" A ")
                .pattern("A A")
                .define('A', ItemTags.PLANKS)
